      ...
      "/modules/": [
        {
          ...
          items: [
            ...
            {
              text: "3. Generating a New Wallet",
              link: "/modules/M1/3_new-wallet.md",
            },
            { text: "4. Sending a token", link: "/modules/M1/4_send-token.md" },
            {
              text: "5. Interacting with Smart Contracts",
              link: "/modules/M1/5_interacting.md",
            },
            {
              text: "6. Setting RC Limits",
              link: "/modules/M1/6_set-rclimit.md",
            },
            {
              text: "7. Using the Faucet",
              link: "/modules/M1/using-the-faucet.md",
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              text: "3. Hold $KOIN get Mana",
              link: "/modules/M2/3_hold_koin_get_mana.md",
            },
            { text: "4. Mana Sharing ", link: "/modules/M2/4_mana-sharing.md" },
            {
              text: "5. Recharging Mana (free)",
              link: "/modules/M2/5_recharge.md",
            },
            {
              text: "6. The Intuitive Value of Mana ",
              link: "/modules/M2/6_price-of-mana.md",
            },
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "2. Downloading the Node",
              link: "/modules/M3/2_download-node.md",
            },
            { text: "3. Inital Setup ", link: "/modules/M3/3_init-setup.md" },
            { text: "4. Starting & Syncing", link: "/modules/M3/4_sync.md" },
            {
              text: "5. Block_producer Configuration",
              link: "/modules/M3/5_config.md",
            },
        ...
        },
        {
          ...
          items: [
            { text: "1. Introduction", link: "/modules/M4/1_introduction.md" },
            {
              ...
              link: "/modules/M4/2_installing_the_sdk.md",
            },
            {
              text: "3. The Hello World Project ",
              link: "/modules/M4/3_hello-world.md",
            },
            {
              text: "4. SDK Folder Structure",
              link: "/modules/M4/4_sdk_folder_structure.md",
            },
            {
              text: "5. Compile Your Contract",
              link: "/modules/M4/5_compile_your_contract.md",
            },
            {
              text: "6. Generating a Wallet",
              link: "/modules/M4/6_generate-wallet.md",
            },
            {
              text: "7. Upload Your Smart Contract via Koinos-CLI",
              link: "/modules/M4/7_upload-contract.md",
            },
            {
              text: "8. Interacting with myawesomecontract",
              link: "/modules/M4/8_interacting.md",
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              text: "3. Customize The Contract",
              link: "/modules/M5/3_modify.md",
            },
        ...
        },
        {
          ...
          items: [
            { text: "1. Introduction", link: "/modules/M6/1_introduction.md" },
            {
              ...
              link: "/modules/M6/2_init-setup.md",
            },
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "2. Setting up our Database",
              link: "/modules/M7/2_setup.md",
            },
          ],
        },
        {
      ...
      "/7_day_dapp/": [
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "Building Part 1",
              link: "/7_day_dapp/2.1_building_frontend.md",
            },
            {
              text: "Building Part 2",
              link: "/7_day_dapp/2.2_building_frontend.md",
            },
            {
              text: "Building Part 3",
              link: "/7_day_dapp/2.3_building_frontend.md",
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              text: "Building Back End",
              link: "/7_day_dapp/3.1_building_backend.md",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              link: "/7_day_dapp/4.0_introduction.md",
            },
            {
              text: "Build Smart Contracts Part 1",
              link: "/7_day_dapp/4.1_building_smartcontract.md",
            },
            {
              text: "Build Smart Contracts Part 2",
              link: "/7_day_dapp/4.2_building_smartcontract.md",
            },
            {
              text: "Build Smart Contracts Part 3",
              link: "/7_day_dapp/4.3_building_smartcontract.md",
            },
          ],
        },
        {
          ...
          items: [
            {
              text: "Compiling Everything",
              link: "/7_day_dapp/6_compiling.md",
            },
          ],
        },
        {
          ...
          items: [
            {
              text: "Deploying to The Blockchain",
              link: "/7_day_dapp/7_deployment.md",
            },
          ],
        },
      ],
      "/concepts/": [
        {
          ...
          items: [
            {
              text: "The Koinos Blockchain",
              link: "/concepts/koinos_introduction.md",
            },
        ...
        },
        {
          text: "Mining",
          collapsed: true,
          items: [{ text: "Koinos Nodes", link: "/concepts/koinos_nodes.md" }],
        },
        {
          text: "Proof of Burn",
          collapsed: true,
          items: [
            ...
            {
              text: "Security of PoB",
              link: "/concepts/koinos_pob_security.md",
            },
            {
              text: "Calculating Block Reward",
              link: "/concepts/koinos_block-reward.md",
            },
            {
              text: "Calculating Mining Yield",
              link: "/concepts/koinos_yield.md",
            },
          ],
        },
        {
